// WebSocket管理器 - Service Worker版本
// 专门为Chrome Manifest V3 Service Worker环境优化

class WebSocketManagerSW {
  constructor() {
    this.ws = null;
...
// Service Worker环境下的全局导出
self.WebSocketManagerSW = WebSocketManagerSW;